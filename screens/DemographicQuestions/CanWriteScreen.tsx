...
export default function CanWriteScreen(){
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.questionContainer}>
                ...
                <QuestionTitle text='¿Sabe escribir?'></QuestionTitle>
                <QuestionText text='Indique si tiene la capacidad de escribir'></QuestionText>
